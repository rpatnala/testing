        ...
        ?>
            <div class='testimonial-item' <?php echo (cretats_get_inline_style(['background' => $bg_color_lighter])); ?>>
                ...
                <div class="testimonial-box" <?php echo ( cretats_get_inline_style(['bg_color' => $bg_color])); ?>>
                    ...
                    <?php endif; ?>
                    <h5 <?php echo (cretats_get_inline_style(['font_size' => $header_font_size, 'color' => $color])); ?>
                        class="smart-slider-title-layout-7">
                        <?php the_title(); ?>
                        <?php if ($designation || $location) : ?>
                            <span <?php echo (cretats_get_inline_style(['font_size'=>$body_font_size,'color'=> $color])); ?>>
                                (<?php echo esc_html($designation); ?> | <?php echo esc_html($location); ?>)
                            </span>
                        <?php endif; ?>
                    </h5>
                    <p <?php echo (cretats_get_inline_style(['font_size' => $body_font_size, 'color' => $color])); ?>
