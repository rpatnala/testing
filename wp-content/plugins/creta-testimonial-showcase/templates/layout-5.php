            ...
            <div id="testimonial-slider" class="testimonial-slider owl-carousel-old owl-theme smart-slider-layout-5">
                ...
                <div class="profile-img smart-slider-profile-img-layout-5" <?php echo ( cretats_get_inline_style([ 'box_shadow' => '0 0 10px 0 ' . $bg_color_darker ,
                   'border'=> '6px solid'.$bg_color ,'background' => $bg_color_darker])); ?>>
                    ...
                    <h5 <?php echo ( cretats_get_inline_style( ['font_size' => $header_font_size, 'color' => $color ])); ?> class="smart-slider-title-layout-5">
                        <?php the_title(); ?>
                    </h5>
                    <div class="px-3" <?php echo ( cretats_get_inline_style( ['font_size' => $body_font_size, 'color' => $color ])); ?>>
                    <?php echo wp_kses_post( strip_tags( get_the_content(), '<strong><em><a><span><div><br>' ) );
                        if ($info && $info != ''){?>
                        <span <?php echo ( cretats_get_inline_style( ['font_size' => $body_font_size, 'color' => $color ])); ?>> <?php echo esc_html( $info ); ?></span> 
                        <?php } ?>
                        </div>
                    ...
                    <div class="feedback mb-1 smart-slider-feedback-layout-5">
                        <?php if ( $designation || $location ) : ?>
                                <small <?php echo ( cretats_get_inline_style( ['font_size'=> $body_font_size,'color'=> $color] )); ?> class="smart-slider-location-layout-5">  
