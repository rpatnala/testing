                ...
                while ( $query->have_posts() ) : $query->the_post();
                    ...
                    <div class="profile-pic" <?php echo ( cretats_get_inline_style([ 'box_shadow' => '0 0 10px 0 ' . $bg_color_lighter])); ?>>
                        ...
                        <div class="testimonial-content">
                            <h5 <?php echo ( cretats_get_inline_style(['font_size' => $header_font_size, 'color' => $color])); ?> class="smart-slider-title-layout-6">
                                <?php the_title(); ?>
                            </h5>
                            <span>
                                <?php if ( $designation || $location ) : ?>
                                    <small <?php echo ( cretats_get_inline_style(['font_size'=>$body_font_size,'color'=> $color])); ?> class="smart-slider-location-layout-6">
                                        <?php echo esc_html( $designation ); ?> | <?php echo esc_html( $location ); ?>
                                    </small>
                                <?php endif; ?>
                            </span>
                            <p <?php echo (cretats_get_inline_style(['font_size' => $body_font_size, 'color' => $color])); ?> class="smart-slider-description-layout-6">
                        ...
                        <?php if ( $rating >= 0 ) : ?>
                            <div class="rating" >
                                <div class="smart-slider-rating-layout-6" <?php echo (cretats_get_inline_style(['font_size' => $body_font_size, 'color' => $color])); ?>>
                                <i class="bi bi-star-fill"></i>
                                <?php echo wp_kses_post( $rating ); ?>

                                </div>
                               
                                <span class="ms-1" <?php echo ( cretats_get_inline_style(['font_size' => $body_font_size, 'color' => $color])); ?>>Rating</span>
                            </div>
                        <?php endif; ?>
                    </div>
                    <?php
