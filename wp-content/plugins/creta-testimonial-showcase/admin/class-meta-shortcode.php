...
if ( !class_exists( 'Cretats_Testimonial_Meta_ShortCode' ) ) {
    class Cretats_Testimonial_Meta_ShortCode {
                    ...
                    <div class="tab-st-content" id="style-tab">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="cretats_color" value="<?php echo esc_attr($color); ?>" class="form-control form-control-color color-picker cretats-full-width">
                            </div>
                            
                            <div class="col-md-4">
                                <label class="form-label">Background Color:</label><br>
                                <input type="text" id="cretats_bg_color" name="cretats_bg_color" value="<?php echo esc_attr($bg_color); ?>" class="form-control form-control-color bg-color-picker cretats-full-width">
                            </div>
                            
                            <div class="col-md-4">
                                <label class="form-label">Block Background Color:</label><br>
                                <input type="text" id="cretats_block_bg_color" name="cretats_block_bg_color" value="<?php echo esc_attr($block_bg_color); ?>" class="form-control form-control-color block-bg-color-picker cretats-full-width">
                            </div>
        ...
        public function cretats_get_preview_html() {
            ...
            $path = plugin_dir_path(__FILE__) . '../templates/' . $layout . '.php';
